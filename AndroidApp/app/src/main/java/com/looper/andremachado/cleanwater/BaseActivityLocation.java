...
import com.looper.andremachado.cleanwater.location.SmartLocationManager;
import com.looper.andremachado.cleanwater.permission.PermissionManager;
import com.looper.andremachado.cleanwater.permission.PermissionManagerInterface;
...
public class BaseActivityLocation extends AppCompatActivity implements LocationManagerInterface {
    ...
    protected void onStart() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            manager.requestPermission(new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.CAMERA});
        }
